        ...
        <div className="flex justify-center mt-4">
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M12 23C14.97 23 17.46 22.02 19.28 20.34L15.71 17.57C14.73 18.23 13.48 18.63 12 18.63C9.19 18.63 6.8 16.73 5.95 14.1H2.27V16.94C4.08 20.47 7.76 23 12 23Z"
                fill="#34A853"
              />
              <path
                d="M5.95 14.1C5.75 13.47 5.63 12.79 5.63 12.09C5.63 11.39 5.75 10.71 5.95 10.08V7.24H2.27C1.46 8.68 1 10.35 1 12.09C1 13.83 1.46 15.5 2.27 16.94L5.95 14.1Z"
                fill="#FBBC05"
              />
              <path
                d="M12 5.55C13.57 5.55 14.97 6.08 16.09 7.15L19.28 3.96C17.46 2.26 14.97 1.27 12 1.27C7.76 1.27 4.08 3.8 2.27 7.33L5.95 10.17C6.8 7.54 9.19 5.55 12 5.55Z"
                fill="#EA4335"
              />
            </svg>
            Google
